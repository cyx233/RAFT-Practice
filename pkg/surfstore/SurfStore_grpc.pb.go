...
type MetaStoreClient interface {
	...
	GetHashAddrMap(ctx context.Context, in *BlockHashes, opts ...grpc.CallOption) (*HashAddrMap, error)
...
func (c *metaStoreClient) GetHashAddrMap(ctx context.Context, in *BlockHashes, opts ...grpc.CallOption) (*HashAddrMap, error) {
	out := new(HashAddrMap)
	err := c.cc.Invoke(ctx, "/surfstore.MetaStore/GetHashAddrMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MetaStoreServer interface {
	...
	GetHashAddrMap(context.Context, *BlockHashes) (*HashAddrMap, error)
...
func (UnimplementedMetaStoreServer) GetHashAddrMap(context.Context, *BlockHashes) (*HashAddrMap, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHashAddrMap not implemented")
}
...
func _MetaStore_GetHashAddrMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockHashes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MetaStoreServer).GetHashAddrMap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/surfstore.MetaStore/GetHashAddrMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetaStoreServer).GetHashAddrMap(ctx, req.(*BlockHashes))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetaStore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHashAddrMap",
			Handler:    _MetaStore_GetHashAddrMap_Handler,
		},
		{
...
func (c *raftSurfstoreClient) GetHashAddrMap(ctx context.Context, in *BlockHashes, opts ...grpc.CallOption) (*HashAddrMap, error) {
	out := new(HashAddrMap)
	err := c.cc.Invoke(ctx, "/surfstore.RaftSurfstore/GetHashAddrMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRaftSurfstoreServer) GetHashAddrMap(context.Context, *BlockHashes) (*HashAddrMap, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetHashAddrMap not implemented")
}
...
func _RaftSurfstore_GetHashAddrMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BlockHashes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftSurfstoreServer).GetHashAddrMap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/surfstore.RaftSurfstore/GetHashAddrMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftSurfstoreServer).GetHashAddrMap(ctx, req.(*BlockHashes))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RaftSurfstore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetHashAddrMap",
			Handler:    _RaftSurfstore_GetHashAddrMap_Handler,
		},
		{
			MethodName: "GetBlockStoreAddrs",
